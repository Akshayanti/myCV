...
{\textbf{Software Engineer} at \textbf{Twilio}, Czechia} 
    ...
    \begin{itemize}
        ...
        \item Participated in post-Private Beta delivery and maintenance of a low latency, highly available distributed system that used Kafka Streams to aggregate data in near real time, providing end-to-end data refresh latency of under 30 seconds. \textbf{Key Technologies}: Java, Docker, Kafka, AWS
